...
<table class="table">
          ...
          <tbody>
              <?php  foreach($list as $chat){
                  ?>
              <tr>
                  <td class="first-td">  <?php echo $chat->getKeeper()->getUserName();     ?></td>
                  <td class="first-td">  <?php echo $chat->getKeeper()->getName();     ?></td>
                  <td class="first-td">  <?php echo $chat->getKeeper()->getSurname();     ?></td>
                <td >          
